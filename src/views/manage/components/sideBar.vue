  ...
  <div class="sidebar">
    <div class="sidebar-menu">
      <div class="menu-item" v-for="item in menuList" :key="item.path">
        ...
        <div class="sub-menu-item" :class="defaultActive == subItem.name ? 'active' : ''"
          v-for="subItem in item.children" :key="subItem.path" @click="menuClick(subItem)">
...
onMounted(() => {
  ...
  defaultActive.value = menuList.value[0]?.children[0]?.name;
});
</script>
