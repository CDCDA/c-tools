...
const routes: Array<any> = [
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          ...
          ico: "icons/格式化.ico",
          description: "代码格式化",
          icon: "pluginIcons-格式化",
          shortcut: "Alt+N",
          type: "tool",
          showHeader: true,
        },
        component: () => import("@/views/plugins/codeFormater/index.vue"),
      },
      // {
      //   path: "/systemInfo",
      //   name: "systemInfo",
      ...
      },
      {
        ...
        meta: {
          ...
          icon: "pluginIcons-markdown",
          ico: "icons/markdown.ico",
          shortcut: "Alt+M",
          showHeader: true,
          transparent: false,
          type: "tool",
        ...
        component: () => import("@/views/plugins/mdEditor/index.vue"),
      },
      {
        path: "/shell",
        name: "shell",
        meta: {
          id: 17,
          label: "Shell命令",
          description: "执行和保存shell命令",
          icon: "pluginIcons-shell",
          ico: "icons/shell.ico",
          shortcut: "Alt+L",
          showHeader: true,
          transparent: false,
  ...
  },
  {
    path: "/pluginManage",
    name: "pluginManage",
    meta: { name: "插件管理", isHidden: true },
    component: () => import("/src/views/pluginManage/index.vue"),
    children: [
      {
